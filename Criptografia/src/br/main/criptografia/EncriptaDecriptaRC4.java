...
//	}
	...
	public String decriptografa(final String msg) {
		return new String(decriptografa(msg.toCharArray()));
	}
	...
	public String criptografa(final String msg) {
		return new String(criptografa(msg.toCharArray()));
	}
	...
	public void setKey(String key) throws InvalidKeyException {
		if (!(key.length() >= TAM_MIN_CHAVE && key.length() < SBOX_LENGTH)) {
			throw new InvalidKeyException(
					"Tamanho da chave deve ser entre " + TAM_MIN_CHAVE + " e " + (SBOX_LENGTH - 1));
		}
